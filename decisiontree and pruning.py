...
# hand-coded decision tree and post pruning
...
class DecisionTree:
    ...
    def _fit(self, trainAttrbt, trainLabel, criterion, rootNode, usedAttrbt={}):
        clsCount = {}
        splitNode = {}
    ...
    def fit(self, trainAttrbt, trainLabel, criterion, usedAttrbt={}):
        root = Nodes()
...
class PostPruning:
    ...
    def _nonLeafNodesList(self, treeRoot, nodelist=[]):
